package cn.edu.bjtu.nourriture.ui.base;
...
import cn.edu.bjtu.nourriture.task.AsyncCallable;
import cn.edu.bjtu.nourriture.task.Callback;
import cn.edu.bjtu.nourriture.task.EMobileTask;
import cn.edu.bjtu.nourriture.task.ProgressCallable;
...
public abstract class BaseActivity extends Activity {
	...
	protected <T> void doAsync(final int pTitleResID, final int pMessageResID, final Callable<T> pCallable, final Callback<T> pCallback, final Callback<Exception> pExceptionCallback) {
		cn.edu.bjtu.nourriture.task.EMobileTask.doAsync(this, pTitleResID, pMessageResID, pCallable, pCallback, pExceptionCallback);
	}
